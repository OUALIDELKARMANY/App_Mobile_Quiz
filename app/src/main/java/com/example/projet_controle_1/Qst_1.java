...
public class Qst_1 extends AppCompatActivity {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(rg.getCheckedRadioButtonId() == -1){
                    ...
                    Toast.makeText(Qst_1.this, "Merci de choisir un champs",
                    ...
                    Intent i1 = new Intent(getApplicationContext(),Qst_2.class);
